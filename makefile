...
$(BIN)/solve_tsplib.o: $(SRC)/solve_tsplib.f08 $(OBJ)/const.mod $(OBJ)/check_util.mod $(OBJ)/tsp.mod
	$(COMPILE) -c $< -o $@
...
$(BIN)/solve_tsplib: $(OBJ)/solve_tsplib.o $(OBJ)/const.o $(OBJ)/check_util.o $(OBJ)/tsp.o
	$(LINK) $^ -o $@
