...
$(OBJ)/const.o: $(SRC)/const.f08
	$(COMPILE) -c $< -o $@

$(OBJ)/check_util.o: $(SRC)/check_util.f08
	$(COMPILE) -c $< -o $@

$(OBJ)/sort.o: $(SRC)/sort.f08
	$(COMPILE) -c $< -o $@
...
$(OBJ)/test_rng.o: $(SRC)/test_rng.f08 $(OBJ)/const.mod
	$(COMPILE) -c $< -o $@
...
$(OBJ)/solve_tsplib.o: $(SRC)/solve_tsplib.f08 $(OBJ)/const.mod $(OBJ)/check_util.mod $(OBJ)/tsp.mod $(OBJ)/pretty_print.mod $(OBJ)/brkga_tsp.mod $(OBJ)/brkga.mod
	$(COMPILE) -c $< -o $@
...
$(BIN)/solve_tsplib: $(OBJ)/solve_tsplib.o $(OBJ)/const.o $(OBJ)/check_util.o $(OBJ)/pretty_print.o $(OBJ)/brkga_tsp.o $(OBJ)/tsp.o $(OBJ)/sort.o $(OBJ)/brkga.o
	$(LINK) $^ -o $@
